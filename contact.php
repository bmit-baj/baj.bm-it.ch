  ...
  <body>
    ...
    <nav id="colorlib-main-nav" role="navigation">
      ...
      <div class="js-fullheight colorlib-table">
      	<div class="img" style="background-image: url(images/night-4928400.jpg);"></div>
        <div class="colorlib-table-cell js-fullheight">
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              <h1 class="mb-4"><a href="index.html" class="logo">Justin Bauer</a></h1>
              <ul>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="colorlib-navbar-brand">
                <a class="colorlib-logo" href="index.html"><span class="logo-img" style="background-image: url(images/PB.jpg);"></span>Justin Bauer</a>
              </div>
        ...
        <div class="container mt-5">
          <div class="row d-flex mb-5 contact-info">
            <div class="col-md-12 mb-4">
              <h2 class="h4">Kontakt informationen</h2>
            </div>
            <div class="w-100"></div>
            <div class="col-md-3">
              <p><span>Handy:</span> <a href="tel://+41764669270">+ 41 76 466 92 70</a></p>
            </div>
            <div class="col-md-3">
              <p><span>Mail:</span> <a href="mailto:justin.bauer@espas.ch">justin.bauer@espas.ch</a></p>
            </div>
            <div class="col-md-3">
          ...
          <div class="row mb-5 justify-content-center">
            <div class="col-md-5 text-center">
              ...
              <div class="ftco-footer-widget">
                <h2 class="mb-3">Kontaktiere mich!</h2>
                <p class="h3 email"><a href="mailto:justin.bauer@espas.ch">justin.bauer@espas.ch</a></p>
              </div>
            </div>
          </div>
          <div class="row">
